...
const linkClass = `p-2 flex justify-center items-center bg-amber-100 font-bold text-center w-[130px] h-[100px]`
  ...
  return (
    <div className="p-10 flex justify-center mx-auto">
        ...
        <ul className="flex gap-4 flex-wrap mt-8">
            <Link to="tictactoe"><li className={linkClass}>Tic Tac Toe</li></Link>
